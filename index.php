...
<body>
    ...
    <div class="col-lg-8 mx-auto p-4 py-md-5">
        ...
        <main>
            ...
            <div class="row g-5">
                <div class="col-md-6">
                    <h2 class="text-body-emphasis">GPDR</h2>
                    <p>Links for Politics in Spanish</p>
                    <ul class="list-unstyled ps-0">
                        <li>
                            <a class="icon-link mb-1" href="<?= dirname($_SERVER['PHP_SELF']); ?>" rel="noopener">
                        ...
                        <li>
                            <a class="icon-link mb-1" href="<?= dirname($_SERVER['PHP_SELF']); ?>/politicas/politica-privacidad" rel="noopener">
                                <svg class="bi" width="16" height="16">
                                    <use xlink:href="#arrow-right-circle" />
                                </svg>
                        ...
                        <li>
                            <a class="icon-link mb-1" href="<?= dirname($_SERVER['PHP_SELF']); ?>/politicas/politica-cookies" rel="noopener">
                                <svg class="bi" width="16" height="16">
                                    <use xlink:href="#arrow-right-circle" />
                                </svg>
                                Politica de Cookies
                        ...
                        <li>
                            <a class="icon-link mb-1" href="<?= dirname($_SERVER['PHP_SELF']); ?>/politicas/politica-avisolegal" rel="noopener">
                                <svg class="bi" width="16" height="16">
                                    <use xlink:href="#arrow-right-circle" />
                                </svg>
                                Aviso Legal
        ...
        <footer class="pt-5 my-5 text-body-secondary border-top">
            Use Bootstrap &middot; &copy; 2023
        </footer>
    </div>
